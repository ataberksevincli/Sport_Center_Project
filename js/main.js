...
function showYoga() {
  updateClassInfo("Yoga", "images/yoga.jpg", "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Id voluptas accusantium molestiae illo hic? Commodi ducimus quo voluptatibus molestias ipsum nam dolorum quia dolor earum.", "Saturday-Sunday: 8:00am - 10:00am", "Monday-Tuesday: 10:00am - 12:00pm", "Wednesday-Friday: 3:00pm - 6:00pm");
}

function showGroup() {
  updateClassInfo("Group", "images/group.webp", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam bibendum urna at quam viverra, a fermentum libero vulputate. Aliquam scelerisque urna est, ornare mollis urna.", "Saturday-Sunday: 10:00am - 12:00am", "Monday-Tuesday: 12:00am - 14:00pm", "Wednesday-Friday: 14:00pm - 16:00pm");
}

function showSolo() {
  updateClassInfo("Solo", "images/solo.jpg", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras interdum urna vitae dolor ornare ornare. Donec vulputate turpis sed interdum vulputate. Aenean consectetur arcu vel.", "Saturday-Sunday: 12:00am - 14:00am", "Monday-Tuesday: 14:00am - 16:30pm", "Wednesday-Friday: 17:20pm - 19:30pm");
}

function showStretching() {
  updateClassInfo("Stretching", "images/stret.webp", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque massa nunc, volutpat sit amet arcu nec, finibus gravida nulla. Pellentesque habitant morbi tristique senectus et.", "Saturday-Sunday: 18:00am - 20:00am", "Monday-Tuesday: 20:00am - 20:30pm", "Wednesday-Friday: 20:30pm - 22:30pm");
}
...
function updateClassInfo(title, image, description, time1, time2, time3) {
  ...
  document.getElementById("title-2").textContent = `When
